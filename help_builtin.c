...
/**
 * help_all - will show all possible builtin shell commands.
 */
void help_all(void)
{
...
/**
 * help_alias - will show information on shell builtin command 'alias'.
 */
...
/**
 * help_cd - will show information on shell builtin command 'cd'.
 */
...
/**
 * help_exit - will show information on shell builtin command 'exit'.
 */
...
/**
 * help_help - will show information on shell builtin command 'help'.
 */
